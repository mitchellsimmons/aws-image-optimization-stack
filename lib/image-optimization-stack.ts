...
export class ImageOptimizationStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    S3_TRANSFORMED_IMAGE_BUCKET_NAME =
      this.node.tryGetContext('S3_TRANSFORMED_IMAGE_BUCKET_NAME') ||
      S3_TRANSFORMED_IMAGE_BUCKET_NAME;
    ...
    var iamPolicyStatements = [s3ReadOriginalImagesPolicy, s3ListBucketPolicy];
